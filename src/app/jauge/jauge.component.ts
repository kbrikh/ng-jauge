...
export class JaugeComponent implements OnInit {
  ...
  circle(i, target): any {
    ...
    context.fillText(data + '%', 177, 205);
    context.beginPath();
    context.arc(200, 200, this.size, Math.PI / 2, (3 / 2) * Math.PI);
    ...
    context.stroke();
    context.beginPath();
    context.arc(200, 200, this.size, (-1 / 2) * Math.PI, (data / 100) * 2 * Math.PI - (1 / 2) * Math.PI);
    context.lineWidth = '20';
